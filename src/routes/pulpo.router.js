...
const pulpo_class_1 = __importDefault(require("../modules/pulpo/class/pulpo.class"));
...
router.get('/utc/', function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let lectura = yield pulpo_class_1.default.timeUTC();
            if (lectura == null)
                res.status(404).send();
            else
                res.send(lectura);
...
router.get('/programacion/:refPulpo', function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let programacion = yield pulpo_class_1.default.showProgramacion(req.body.refPulpo);
...
router.post('/estado/', function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let estado = yield pulpo_class_1.default.saveEstado({
...
router.post('/lectura/:refContador', upload.single('photo'), function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let lectura = yield pulpo_class_1.default.saveLectura({
...
router.get('/db/', function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let ok = yield pulpo_class_1.default.restartDB();
            if (ok == false)
                res.status(404).send();
            else
                res.status(200).send();
