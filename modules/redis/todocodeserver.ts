...
export class class_mngCache extends absModule {
    ...
    constructor( arrParams: any ) {
        ...
        let arrRedisConfig_server = this.arrParams.objConfig.arrConfig_RedisServer;
     ...
     */
    async setCached( strKey: String, rawValue: any ) {
        await this.objMultiCache.set( strKey, rawValue );
    }
